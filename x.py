...
SOT_CHECK_GUARDS = (
    ...
    },
    {
        ...
        #      وتعفّنُ الأحكامِ (يُوصَلُ مدمَجٌ موجودٌ بذراعِ إرسالٍ فلا يتغيّرُ
        #      اسمٌ ويبقى التوثيقُ يقولُ «لا يحلُّه المترجّم»). فيُقاسُ الزمنُ:
        #      أيُّ إيداعٍ مسَّ طبقةَ الإرسالِ بعدَ الإيداعِ المقيسِ يُحمِرُّه.
        #      حدٌّ مُعلَن: تغطيةٌ وطزاجةٌ لا صحّةُ كلِّ سطرٍ — تلك لا تُعرَفُ إلّا
        #      بإعادةِ تشغيلِ المِجَسِّ على ثنائيَّين مبنيَّين، وهو أثقلُ من بوّابةِ PR.
        # (EN) The measured record must cover today's declared builtin set and
        #      no dispatch-layer commit may postdate the measured commit.
