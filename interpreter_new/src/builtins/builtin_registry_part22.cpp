/**
 * @file builtin_registry_part22.cpp
 * @brief (AR) دوال GPU/رسوميات الموسّعة — framebuffer متقدم بدون نظام تشغيل
 * @brief (EN) Extended GPU/Graphics functions — advanced framebuffer for bare-metal
 */
...
void registerBuiltinsPart22(Interpreter& interpreter) {
