/**
 * @file builtin_registry_part28.cpp
 * @brief (AR) دوال الاتصال التسلسلي — UART 16550، COM1-COM4
 * @brief (EN) Serial/UART 16550 functions — COM1-COM4
 */
...
void registerBuiltinsPart28(Interpreter& interpreter) {
