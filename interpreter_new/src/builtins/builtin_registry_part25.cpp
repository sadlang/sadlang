/**
 * @file builtin_registry_part25.cpp
 * @brief (AR) دوال مكدس الشبكة — Ethernet، ARP، IP، ICMP، UDP
 * @brief (EN) Network stack functions — Ethernet, ARP, IP, ICMP, UDP
 */
...
void registerBuiltinsPart25(Interpreter& interpreter) {
