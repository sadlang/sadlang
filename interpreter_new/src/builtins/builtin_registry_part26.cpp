/**
 * @file builtin_registry_part26.cpp
 * @brief (AR) دوال الصوت — AC'97، HDA، PC Speaker، تشغيل، تسجيل
 * @brief (EN) Audio functions — AC'97, HDA, PC Speaker, playback, recording
 */
...
void registerBuiltinsPart26(Interpreter& interpreter) {
