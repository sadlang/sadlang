...
| **مرجع اللغة الكامل** (النحو، الكلمات الـ40، الماكروز، التزامن، العقود، مطابقة الأنماط) | `وثائق/الفهرس.md` (الفهرس) + مجلّدات `وثائق/البرمجة_الكائنية`, `وثائق/التحكم_بالتدفق`, `وثائق/ميزات_متقدمة` |
