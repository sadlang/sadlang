; ModuleID = 'test_less9.sad'
source_filename = "test_less9.sad"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

@0 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@1 = private unnamed_addr constant [9 x i8] c"\D9\83\D8\A8\D9\8A\D8\B1\00", align 1
@2 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@4 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@5 = private unnamed_addr constant [9 x i8] c"\D8\B5\D8\BA\D9\8A\D8\B1\00", align 1
...
then_6:                                           ; preds = %else_5
  ...
  %cmpgttmp7 = icmp sgt i64 %auto.load6, 100
  br i1 %cmpgttmp7, label %then_8, label %merge_9

merge_7:                                          ; preds = %merge_11, %else_5
  br label %merge_4
...
merge_9:                                          ; preds = %then_8, %then_6
  %auto.load8 = load i64, ptr %alloca5, align 8
  %cmplttmp = icmp slt i64 %auto.load8, 5
  br i1 %cmplttmp, label %then_10, label %merge_11
