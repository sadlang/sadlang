; ModuleID = 'test_exc_minimal2'
source_filename = "test_exc_minimal2"
...
@str.const.1 = private unnamed_addr constant [4 x i8] c"\D8\A3=\00", align 1
@int.fmt = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@fmt.s = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@str.const.2 = private unnamed_addr constant [7 x i8] c"\D8\AE\D8\B7\D8\A3\00", align 1
...
entry:
  ...
  br i1 %cmpnetmp, label %catch_body_4, label %try_body_3

catch_body_4:                                     ; preds = %entry
...
try_body_3:                                       ; preds = %entry
  %calltmp = call i64 @"\D8\AA\D8\AD\D9\82\D9\82"(i64 5)
  ...
  %len1 = call i64 @strlen(ptr @str.const.1)
  ...
  %2 = call ptr @memcpy(ptr %concat.buf, ptr @str.const.1, i64 %len1)
...
try_exit_6:                                       ; preds = %catch_body_4, %try_body_3
  ret void
}
