...
static const std::unordered_map<ErrorCode, ErrorDescription> errorDescriptions = {
    ...
    {ErrorCode::LEX_INVALID_CHARACTER, {
        "رمز غير صالح في الكود المصدري",
        "Invalid character in source code"
    }},
    {ErrorCode::LEX_UNTERMINATED_STRING, {
        "نص غير مغلق - متوقع علامة اقتباس '\"' في النهاية",
    ...
    {ErrorCode::LEX_INVALID_ESCAPE, {
        "تسلسل هروب غير صالح في النص",
        "Invalid escape sequence in string"
    }},
    {ErrorCode::LEX_NUMBER_TOO_LARGE, {
        "الرقم كبير جداً ويتجاوز الحد المسموح",
        "Number too large and exceeds allowed limit"
    }},
    {ErrorCode::LEX_INVALID_UTF8, {
        "ترميز UTF-8 غير صالح في الملف",
    ...
    {ErrorCode::SYN_UNEXPECTED_TOKEN, {
        "رمز غير متوقع في هذا الموضع",
        "Unexpected token at this position"
    }},
    {ErrorCode::SYN_MISSING_SEMICOLON, {
        "فاصلة منقوطة ';' مفقودة في نهاية الجملة",
        "Missing semicolon ';' at end of statement"
    }},
    {ErrorCode::SYN_UNCLOSED_BRACKET, {
        "قوس غير مغلق - متوقع قوس إغلاق مطابق",
        "Unclosed bracket - expected matching closing bracket"
    }},
    {ErrorCode::SYN_MISSING_IDENTIFIER, {
        "معرّف مفقود - متوقع اسم متغير أو دالة",
        "Missing identifier - expected variable or function name"
    }},
    {ErrorCode::SYN_INVALID_EXPRESSION, {
        "تعبير غير صالح أو غير مكتمل",
        "Invalid or incomplete expression"
    }},
    {ErrorCode::SYN_UNEXPECTED_EOF, {
        "نهاية ملف غير متوقعة - الكود غير مكتمل",
        "Unexpected end of file - code is incomplete"
    }},
    {ErrorCode::SYN_MISSING_COLON, {
        "نقطتان ':' مفقودتان",
        "Missing colon ':'"
    }},
    {ErrorCode::SYN_INVALID_ASSIGNMENT, {
        "إسناد غير صالح - تحقق من الصيغة",
        "Invalid assignment - check syntax"
    }},
    ...
    {ErrorCode::SEM_UNDEFINED_VARIABLE, {
        "متغير غير معرّف - لم يتم الإعلان عن هذا المتغير",
        "Undefined variable - this variable was not declared"
    }},
    {ErrorCode::SEM_TYPE_MISMATCH, {
        "عدم تطابق الأنواع - الأنواع غير متوافقة",
        "Type mismatch - types are incompatible"
    }},
    {ErrorCode::SEM_REDEFINITION, {
        "إعادة تعريف - هذا الاسم معرّف مسبقاً",
        "Redefinition - this name is already defined"
    }},
    {ErrorCode::SEM_UNDEFINED_FUNCTION, {
        "دالة غير معرّفة - لم يتم الإعلان عن هذه الدالة",
        "Undefined function - this function was not declared"
    }},
    {ErrorCode::SEM_WRONG_ARG_COUNT, {
        "عدد معاملات خاطئ - لا يطابق توقيع الدالة",
        "Wrong argument count - does not match function signature"
    }},
    {ErrorCode::SEM_INVALID_OPERATION, {
        "عملية غير صالحة على هذه الأنواع",
        "Invalid operation on these types"
    }},
    {ErrorCode::SEM_CONST_ASSIGNMENT, {
        "إسناد لثابت - لا يمكن تغيير قيمة ثابت",
        "Assignment to constant - cannot change constant value"
    }},
    {ErrorCode::SEM_UNDEFINED_CLASS, {
        "صنف غير معرّف - لم يتم الإعلان عن هذا الصنف",
        "Undefined class - this class was not declared"
    }},
    {ErrorCode::SEM_PRIVATE_ACCESS, {
        "وصول لعضو خاص - العضو غير متاح خارج الصنف",
        "Access to private member - member not accessible outside class"
    }},
    ...
    {ErrorCode::RUN_DIVISION_BY_ZERO, {
        "قسمة على صفر - عملية رياضية غير معرّفة",
        "Division by zero - undefined mathematical operation"
    }},
    {ErrorCode::RUN_INDEX_OUT_OF_RANGE, {
        "فهرس خارج النطاق - الفهرس غير صالح للمصفوفة",
        "Index out of range - index invalid for array"
    }},
    {ErrorCode::RUN_NULL_REFERENCE, {
        "مرجع فارغ - محاولة الوصول لقيمة null",
        "Null reference - attempting to access null value"
    }},
    {ErrorCode::RUN_STACK_OVERFLOW, {
        "تجاوز سعة المكدس - ربما استدعاء متكرر غير محدود",
        "Stack overflow - possibly infinite recursion"
    }},
    {ErrorCode::RUN_KEY_NOT_FOUND, {
        "مفتاح غير موجود في القاموس",
        "Key not found in dictionary"
    }},
    {ErrorCode::RUN_INVALID_CAST, {
        "تحويل نوع غير صالح - لا يمكن تحويل القيمة",
        "Invalid type cast - cannot convert value"
    }},
    {ErrorCode::RUN_FILE_ERROR, {
        "خطأ في العمليات على الملف",
        "File operation error"
    }},
    {ErrorCode::RUN_IMPORT_ERROR, {
        "خطأ في استيراد الوحدة - الملف غير موجود أو به أخطاء",
        "Import error - file not found or contains errors"
    }}
};
