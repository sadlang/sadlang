; ModuleID = 'C:\s\s_language\working_exampels\02_math\test_math_positive.sad'
source_filename = "C:\\s\\s_language\\working_exampels\\02_math\\test_math_positive.sad"
...
@26 = private unnamed_addr constant [19 x i8] c"\D8\A3\D8\B1\D8\B6\D9\8A\D8\A9(3.9) = \00", align 1
...
@33 = private unnamed_addr constant [15 x i8] c"\D8\B3\D9\82\D9\81(3.1) = \00", align 1
...
entry:
  ...
  %11 = call i32 (ptr, ...) @printf(ptr @20, i64 %round.toi64)
  ...
  %15 = call i32 (ptr, ...) @printf(ptr @27, i64 %floor.toi64)
  ...
  %19 = call i32 (ptr, ...) @printf(ptr @34, i64 %ceil.toi64)
