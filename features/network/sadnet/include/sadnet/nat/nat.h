...
// (EN) NAT traversal: STUN binding, TURN relay, ICE connectivity// المكون: features/network/sadnet (اجتياز NAT)
// المسار: features/network/sadnet/include/sadnet/nat/nat.h// ═══════════════════════════════════════════════════════════════════
