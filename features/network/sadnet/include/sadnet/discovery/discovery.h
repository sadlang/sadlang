...
// (EN) Peer discovery: LAN multicast, DHT bootstrap, PEX// المكون: features/network/sadnet (اكتشاف الأقران)
// المسار: features/network/sadnet/include/sadnet/discovery/discovery.h// ═══════════════════════════════════════════════════════════════════
