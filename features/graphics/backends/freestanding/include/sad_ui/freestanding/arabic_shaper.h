    ...
    namespace ui
    {
        namespace freestanding
        {
            namespace arabic
            {
                ...
                /**
                 * @brief (AR) طيّ شكل عرضٍ-B (FE70–FEFF) إلى حرفه الأساسيّ (0621–064A)
                 * @brief (EN) Fold a Presentation Form-B (FE70–FEFF) to its base letter
                 *
                 * عكس الجدول الأماميّ لـ shape(): كلّ شكل (منفصل/نهائيّ/ابتدائيّ/وسطيّ)
                 * يعود إلى حرفه الأساسيّ. ليغاتورات لام-ألف (FEF5–FEFC) تعود إلى اللام
                 * وحده — أي تفقد الألف كاملةً لا مجرّد الاتّصال (فـ«لا» تُرسَم «ل»)، إذ
                 * الخطّ النقطيّ بلا ليغاتورة. نقطة خارج مقطع أشكال العرض-B — أو داخله
                 * لكنّها ليست في الجدولين (تشكيلات FE70–FE7F التي لا يُخرجها المُشكِّل) —
                 * تعود كما هي. غايته: خطّ نقطيّ يفهرس الحروف الأساسيّة فقط يجد غليفًا
                 * للنقطة المُشكَّلة بدل مربّع الاستبدال (خسارة الاتّصال/الليغاتورة مقبولة
                 * — دَين الخطّ الكامل معلَن، راجع psf_font.h).
                 */
