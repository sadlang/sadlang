...
int main() {
    ...
    SAD_TEST("LOOP04: لكل (for) عداد", {
        auto code = "\xD9\x85\xD8\xAA\xD8\xBA\xD9\x8A\xD8\xB1 sum = 0\n"
                     "\xD9\x84\xD9\x83\xD9\x84 (\xD9\x85\xD8\xAA\xD8\xBA\xD9\x8A\xD8\xB1 i = 1; i <= 10; i++) {\n"
                     "  sum += i\n"
                     "}";
        auto v = runAndGetVar(code, "sum");
        SAD_ASSERT_EQ(v.toInt(), 55);
    ...
    SAD_TEST("OOP01: إنشاء صنف واستخدامه", {
        auto code = "\xD8\xB5\xD9\x86\xD9\x81 Counter {\n"
                     "  \xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9 \xD8\xA8\xD8\xA7\xD9\x86\xD9\x8A() {\n"
                     "    \xD9\x87\xD8\xB0\xD8\xA7.count = 0\n"
                     "  }\n"
                     "  \xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9 increment() {\n"
                     "    \xD9\x87\xD8\xB0\xD8\xA7.count = \xD9\x87\xD8\xB0\xD8\xA7.count + 1\n"
                     "  }\n"
    ...
    SAD_TEST("OOP02: صنف بسيط مع خاصية", {
        auto code = "\xD8\xB5\xD9\x86\xD9\x81 Point {\n"
                     "  \xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9 \xD8\xA8\xD8\xA7\xD9\x86\xD9\x8A(x, y) {\n"
    ...
    SAD_TEST("ALGO01: أكبر من عددين", {
        auto code = "\xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9 max(a, b) {\n"
                     "  \xD8\xA5\xD8\xB0\xD8\xA7 (a > b) { \xD8\xA7\xD8\xB1\xD8\xAC\xD8\xB9 a }\n"
    ...
    SAD_TEST("ALGO02: القيمة المطلقة", {
        auto code = "\xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9 abs_val(n) {\n"
                     "  \xD8\xA5\xD8\xB0\xD8\xA7 (n < 0) { \xD8\xA7\xD8\xB1\xD8\xAC\xD8\xB9 -n }\n"
                     "  \xD8\xA7\xD8\xB1\xD8\xAC\xD8\xB9 n\n"
                     "}\n"
    ...
    SAD_TEST("ALGO04: عدد أولي بسيط", {
        auto code = "\xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9 isPrime(n) {\n"
                     "  \xD8\xA5\xD8\xB0\xD8\xA7 (n < 2) { \xD8\xA7\xD8\xB1\xD8\xAC\xD8\xB9 \xD8\xAE\xD8\xB7\xD8\xA3 }\n"
                     "  \xD9\x85\xD8\xAA\xD8\xBA\xD9\x8A\xD8\xB1 i = 2\n"
                     "  \xD8\xA8\xD9\x8A\xD9\x86\xD9\x85\xD8\xA7 (i * i <= n) {\n"
                     "    \xD8\xA5\xD8\xB0\xD8\xA7 (n % i == 0) { \xD8\xA7\xD8\xB1\xD8\xAC\xD8\xB9 \xD8\xAE\xD8\xB7\xD8\xA3 }\n"
                     "    i = i + 1\n"
                     "  }\n"
    ...
    SAD_TEST("PROG01: FizzBuzz عداد", {
        auto code = "\xD9\x85\xD8\xAA\xD8\xBA\xD9\x8A\xD8\xB1 fizz = 0\n"
                     ...
                     "  \xD8\xA5\xD8\xB0\xD8\xA7 (i % 3 == 0) { fizz = fizz + 1 }\n"
                     "  \xD8\xA5\xD8\xB0\xD8\xA7 (i % 5 == 0) { buzz = buzz + 1 }\n"
                     "  i = i + 1\n"
                     "}";
    ...
    SAD_TEST("PROG03: عد أرقام زوجية", {
        auto code = "\xD9\x85\xD8\xAA\xD8\xBA\xD9\x8A\xD8\xB1 even = 0\n"
                     ...
                     "  \xD8\xA5\xD8\xB0\xD8\xA7 (i % 2 == 0) { even = even + 1 }\n"
                     "  i = i + 1\n"
                     "}";
