...
static const std::vector<RegressionTest> REGRESSION_TESTS = {
    // P0 - عاجل / Critical
    {"test_p01_array_key_access.ص", "arr[i][key] داخل الدوال", "P0", false, 10},        // مُصلَح
    {"test_p02_while_update.ص", "تحديث المتغير في بينما", "P0", false, 10},             // Green test: الخطأ #2 مُصلح
    {"test_p03_length_depth.ص", "الطول() بعمق استدعاء ≥ 2", "P0", false, 10},           // مُصلَح
    {"test_p09_reserved_words.ص", "كلمات محجوزة غير موثقة", "P0", false, 10},           // مُصلَح
    {"test_p10_void_return.ص", "ارجع بدون قيمة", "P0", false, 10},                      // مُصلَح
    {"test_p11_custom_class_fields.ص", "أصناف مخصصة كحقول", "P0", false, 10},           // مُصلَح
    {"test_p12_integer_division.ص", "القسمة الصحيحة تنتج عشري", "P0", false, 10},       // مُصلَح
    {"test_p16_compound_field.ص", "+= على حقل كائن في مصفوفة", "P0", false, 10},        // مُصلَح
    {"test_p18_this_method_save.ص", "هذا.method() لا يحفظ التغييرات", "P0", false, 10}, // مُصلَح
    {"test_p19_hex_literals.ص", "0xFF غير مدعومة", "P0", false, 10},                    // مُصلَح

    // P1 - مهم / Important
    {"test_p04_hamza_var.ص", "متغيرات الهمزة إ", "P1", false, 10},                       // مُصلَح
    {"test_p08_break.ص", "توقف واستمر في الحلقات", "P1", false, 10},                     // مُصلَح
    {"test_p13_class_prefix.ص", "صنف كبادئة للمعرفات", "P1", false, 10},                 // مُصلَح
    {"test_p14_cascading_errors.ص", "خطأ واحد يسبب سلسلة", "P1", false, 10},             // مُصلَح
    {"test_p17_undocumented_reserved.ص", "جديد/سجل محجوزة بدون توثيق", "P1", false, 10}, // مُصلَح
    {"test_p20_super_reserved.ص", "أساس محجوزة كـ KEYWORD_SUPER", "P1", false, 10},      // مُصلَح
    ...
    {"test_p07_array_pluseq.ص", "+= لإضافة عناصر للمصفوفة", "P2", false, 10}, // مُصلَح
    {"test_p15_utf8_windows.ص", "UTF-8 في طرفية Windows", "P2", false, 10},
    {"test_p21_template_reserved.ص", "قالب محجوزة", "P2", false, 10}, // مُصلَح
