...
IGNORED = {
    ...
    # (AR) سِجِلُّ قياسٍ لا سطحُ لغة: أسماؤه معدودةٌ سلفًا في builtins/،
    #      فعدُّها هنا نسخةٌ ثانيةٌ من الحقيقةِ نفسِها. وهو يتغيّرُ بإعادةِ
    #      القياسِ لا بتوسُّعِ اللغة، فحارسٌ عليه يحمرُّ بلا انجرافٍ في السطح.
    "_meta/builtin_engine_support.yaml": "سِجِلُّ قياسِ المحرّكَين — جوابٌ عن أسماءٍ معدودةٍ في builtins/ لا سطحٌ جديد",
