...
#      🔑 وكان ههنا **تفصيلٌ عدديٌّ ثانٍ** للعدّادِ «د» يُخالِفُ نسختَه في
#      `CLAUDE.md` رقمًا وتفصيلًا، ولا أمرَ يقيسُ أيًّا منهما. فنُزِعَ العددُ
#      من ههنا: التعليلُ لا يحتاجُ عددًا، والعددُ دَينٌ مُسمًّى في `CLAUDE.md`
#      حتّى يُكتَبَ أمرُه. (ولا يُعادُ نقلُ قيمتِه ههنا — نقلُها هو العطبُ.)
