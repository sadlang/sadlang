...
#      فصياغةُ محرّكٍ بعينِه ولا يُحمَلُ على غيره.
#      🔑 وكان ههنا **تفصيلٌ عدديٌّ ثانٍ** للعدّادِ «د» (٣٢٨ = ٢٧٨ · ٨ · ٤٢)،
#      ونسختُه في `CLAUDE.md` تقولُ (٣٣٠ = ٢٧٧ · ٤١ · ١٢) — رقمانِ مختلفانِ
#      وتفصيلانِ متباعدانِ لحقيقةٍ واحدة، ولا أمرَ يقيسُ أيًّا منهما. فنُزِعَ
#      العددُ من ههنا وبقيَ الموضعُ الواحد: التعليلُ لا يحتاجُ عددًا، والعددُ
#      دَينٌ مُسمًّى في `CLAUDE.md` حتّى يُكتَبَ أمرُه.
