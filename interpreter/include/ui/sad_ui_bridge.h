/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * ملف: interpreter/include/ui/sad_ui_bridge.h
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 * (AR) الواجهة العامّة لطبقة جسر الواجهات (sad_ui_bridge) — م2-أ من sadlang-rfcs#10.
 *      نقطة الدخول الوحيدة التي يحتاجها مضيف مفسّر يربط sad_ui_bridge وينفّذ كود
 *      واجهات (sad-run، profiler): استدعِ installSadUIBridge() مرّةً على الخيط
 ...
 *
 * (EN) Public surface of the UI bridge layer (sad_ui_bridge), Phase 2-A. The single
 *      entry point a host that links sad_ui_bridge and runs UI code needs (sad-run,
 *      profiler): call installSadUIBridge() once on the main thread before
...
#ifndef SAD_INTERPRETER_SAD_UI_BRIDGE_H
#define SAD_INTERPRETER_SAD_UI_BRIDGE_H
...
#endif // SAD_INTERPRETER_SAD_UI_BRIDGE_H
