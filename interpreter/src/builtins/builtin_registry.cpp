    ...
    namespace Interpreter
    {
        ...
        std::string BuiltinModuleRegistry::suggestModuleForFunction(const std::string &funcName) const
        {
            ...
            static const std::unordered_map<std::string, std::string> funcToModule = {
                ...
                {std::string(Bb::REAL_PATH), kModBasics},
                {std::string(Bb::ABS_PATH), kModBasics},
                {std::string(Bb::IS_SYMLINK), kModBasics},
                ...
                {std::string(Bcr::BLAKE3_HASH), kModCrypto},
                ...
                {std::string(Bcr::X25519_KEYGEN_PRIV), kModCrypto},
                {std::string(Bcr::X25519_DERIVE_PUB), kModCrypto},
                {std::string(Bcr::X25519_EXCHANGE), kModCrypto},
                {std::string(Bcr::ED25519_KEYGEN_PRIV), kModCrypto},
                {std::string(Bcr::ED25519_DERIVE_PUB), kModCrypto},
                {std::string(Bcr::ED25519_SIGN), kModCrypto},
                {std::string(Bcr::ED25519_VERIFY), kModCrypto},
