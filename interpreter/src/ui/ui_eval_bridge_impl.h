 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 * (AR) تطبيق بذرة عكس الاعتماد في طبقة الجسر (sad_ui_bridge، م2-أ من sadlang-rfcs#10).
 ...
 * (EN) Bridge-side implementation of the dependency-inversion seam (sad_ui_bridge,
...
#include "ui/sad_ui_bridge.h"  // (AR) إعلان installSadUIBridge العامّ (مصدر وحيد)
...
namespace Sad
{
    namespace Interpreter
    {
        ...
        // (AR) installSadUIBridge() مُعلَنة في الترويسة العامّة ui/sad_ui_bridge.h.
        // (EN) installSadUIBridge() is declared in the public header ui/sad_ui_bridge.h.
    }
}
