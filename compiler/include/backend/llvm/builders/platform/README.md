# الفئة: platform/ — المنصة و FFI و UI

> **الموقع:** `compiler/include/backend/llvm/builders/platform/`
> **النوع:** ملفات headers فقط (`.h`)
> **الـ ops files المرافقة في:** `compiler/src/backend/llvm/builders/platform/`
