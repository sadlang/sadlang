...
namespace sad
{
    ...
    public:
        ...
        /**
         * (AR) ضبط وضع LTO — يؤثر على نوع pipeline المُولَّد
         * (EN) Set LTO mode — affects pipeline type built
         * @param enable_full تفعيل FullLTO PreLink pipeline
         * @param enable_thin تفعيل ThinLTO PreLink pipeline
         */
    ...
    private:
        ...
        bool enable_lto_full_ = false; // تفعيل FullLTO PreLink pipeline
        bool enable_lto_thin_ = false; // تفعيل ThinLTO PreLink pipeline
