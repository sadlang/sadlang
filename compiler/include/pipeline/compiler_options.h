...
namespace Sad
{
    namespace Compiler
    {
        ...
        struct CompilerOptions
        {
            ...
            // ═══════════════════════════════════════════════════════════════════════
            //  (AR) Link-Time Optimization (LTO) — تحسين وقت الربط
            //       يفعّل تحسينات عبر الوحدات (cross-module inlining, DCE, devirtualization)
            //  (EN) Link-Time Optimization across whole program
            // ═══════════════════════════════════════════════════════════════════════

            /** (AR) تفعيل LTO الكامل (FullLTO) — أبطأ بناء، أقصى تحسين
             *  (EN) Enable Full LTO — slower build, maximum optimization */
            bool enable_lto_full = false;

            /** (AR) تفعيل ThinLTO — توازن بين سرعة البناء والتحسين
             *  (EN) Enable ThinLTO — balance build speed and optimization */
