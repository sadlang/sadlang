        ...
        namespace targets
        {
            ...
            public:
                ...
                std::string generateLinkerScript()
                {
                    ...
                    script << "/* ═══════════════════════════════════════════════════════════════ */\n";
                    script << "/* " << "نص الربط لـ " << chipInfo_.name << " */\n";
                    script << "/* ═══════════════════════════════════════════════════════════════ */\n\n";
                ...
                std::string generateGpioConstants()
                {
                    ...
                    code << "; ═══════════════════════════════════════════════════════════════\n";
                    code << "; " << "ثوابت GPIO لـ " << chipInfo_.name << "\n";
                    code << "; ═══════════════════════════════════════════════════════════════\n\n";

                    // (AR) عدد منافذ GPIO يعتمد على الشريحة
                    int maxGpio = 40; // ESP32 الأصلي
                    if (chip_ == ESP32ChipType::ESP32_S2)
                        maxGpio = 46;
                    if (chip_ == ESP32ChipType::ESP32_S3)
                        maxGpio = 48;
                    if (chip_ == ESP32ChipType::ESP32_C3)
                        maxGpio = 22;
                    if (chip_ == ESP32ChipType::ESP32_C6)
                        maxGpio = 30;
                ...
                std::string generateWiFiFunctions()
                {
                    ...
                    {
                        return "; " + std::string("هذه الشريحة لا تدعم WiFi") + "\n";
                    }
                ...
                std::string generateBluetoothFunctions()
                {
                    ...
                    {
                        return "; " + std::string("هذه الشريحة لا تدعم Bluetooth") + "\n";
                    }
                ...
                std::string generateDeepSleepFunctions()
                {
                    ...
                    code << "; ═══════════════════════════════════════════════════════════════\n";
                    code << "; " << "دوال النوم العميق" << "\n";
                    code << "; ═══════════════════════════════════════════════════════════════\n\n";

                    code << "; " << "تفعيل مصدر الاستيقاظ" << "\n";
