        ...
        namespace LLVM
        {
            ...
            bool LLVMCompilerPipeline::initialize()
            {
                ...
                try
                {
                    ...
                    // (AR) تطبيق وضع LTO على الـ codegen / (EN) Apply LTO mode
                    codeGen_->setLTOMode(options_.enable_lto_full, options_.enable_lto_thin);
            ...
            bool LLVMCompilerPipeline::typeChecking()
            {
                try
                {
                    ...
                    // (AR) TypeChecker ┘ו┘ט╪¼┘ט╪» ┘ב┘ך compiler/src/semantic/type_checker.cpp
                    ...
                    // (EN) TypeChecker exists in compiler/src/semantic/type_checker.cpp
