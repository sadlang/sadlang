    ...
    namespace FFI
    {
        ...
        LeakDetector::analyzeFunction(const std::string &code)
        {
            ...
            if (freeCount < allocations.size())
            {
                ...
                warning.arabicMessage = "\xD8\xAA\xD8\xB3\xD8\xB1\xD8\xA8 \xD9\x85\xD8\xAD\xD8\xAA\xD9\x85\xD9\x84: " + std::to_string(allocations.size()) + " \xD8\xAA\xD8\xAE\xD8\xB5\xD9\x8A\xD8\xB5 "
                                                                                                                                                             "\xD9\x88 " +
                                        std::to_string(freeCount) + " \xD8\xAA\xD8\xAD\xD8\xB1\xD9\x8A\xD8\xB1";
