...
namespace Sad
{
    namespace LLVM
    {
        ...
        llvm::Value *InstrCoreCodeGen::emitInstructionCore(std::shared_ptr<SIRInstruction> inst)
        {
            ...
            case SIROpcode::BUILTIN_CRYPTO_AEAD_ENCRYPT:
                return cg_.emitBuiltinCryptoAeadEncrypt(inst);
            case SIROpcode::BUILTIN_CRYPTO_AEAD_DECRYPT:
            ...
            case SIROpcode::BUILTIN_FILE_REAL_PATH:
                return cg_.emitBuiltinFileRealPath(inst);
            case SIROpcode::BUILTIN_FILE_ABS_PATH:
                return cg_.emitBuiltinFileAbsPath(inst);
            case SIROpcode::BUILTIN_FILE_WRITE_BYTES:
