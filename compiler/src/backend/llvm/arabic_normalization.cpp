        ...
        public:
            ...
            static std::vector<uint32_t> decomposePresBForm(uint32_t cp)
            {
                ...
                static const std::unordered_map<uint32_t, std::vector<uint32_t>> table = {
                    ...
                    {0xFE81, {0x0622}},
                    {0xFE82, {0x0622}}, // آ Alef Madda
                    {0xFE83, {0x0623}},
                    {0xFE84, {0x0623}}, // أ Alef Hamza Above
                    {0xFE85, {0x0624}},
                    {0xFE86, {0x0624}}, // ؤ Waw Hamza
                    {0xFE87, {0x0625}},
                    {0xFE88, {0x0625}}, // إ Alef Hamza Below
                    {0xFE89, {0x0626}},
                    {0xFE8A, {0x0626}},
                    {0xFE8B, {0x0626}},
                    {0xFE8C, {0x0626}}, // ئ Yeh Hamza
                    {0xFE8D, {0x0627}},
                    {0xFE8E, {0x0627}}, // ا Alef
                    {0xFE8F, {0x0628}},
                    {0xFE90, {0x0628}},
                    {0xFE91, {0x0628}},
                    {0xFE92, {0x0628}}, // ب Beh
                    {0xFE93, {0x0629}},
                    {0xFE94, {0x0629}}, // ة Teh Marbuta
                    {0xFE95, {0x062A}},
                    {0xFE96, {0x062A}},
                    {0xFE97, {0x062A}},
                    {0xFE98, {0x062A}}, // ت Teh
                    ...
                    {0xFE9A, {0x062B}},
                    {0xFE9B, {0x062B}},
                    {0xFE9C, {0x062B}}, // ث Theh
                    {0xFE9D, {0x062C}},
                    {0xFE9E, {0x062C}},
                    {0xFE9F, {0x062C}},
                    {0xFEA0, {0x062C}}, // ج Jeem
                    {0xFEA1, {0x062D}},
                    {0xFEA2, {0x062D}},
                    {0xFEA3, {0x062D}},
                    {0xFEA4, {0x062D}}, // ح Hah
                    ...
                    {0xFEA6, {0x062E}},
                    {0xFEA7, {0x062E}},
                    {0xFEA8, {0x062E}}, // خ Khah
                    {0xFEA9, {0x062F}},
                    {0xFEAA, {0x062F}}, // د Dal
                    {0xFEAB, {0x0630}},
                    {0xFEAC, {0x0630}}, // ذ Thal
                    {0xFEAD, {0x0631}},
                    {0xFEAE, {0x0631}}, // ر Reh
                    {0xFEAF, {0x0632}},
                    {0xFEB0, {0x0632}}, // ز Zain
                    {0xFEB1, {0x0633}},
                    {0xFEB2, {0x0633}},
                    {0xFEB3, {0x0633}},
                    {0xFEB4, {0x0633}}, // س Seen
                    {0xFEB5, {0x0634}},
                    {0xFEB6, {0x0634}},
                    {0xFEB7, {0x0634}},
                    {0xFEB8, {0x0634}}, // ش Sheen
                    {0xFEB9, {0x0635}},
                    {0xFEBA, {0x0635}},
                    {0xFEBB, {0x0635}},
                    {0xFEBC, {0x0635}}, // ص Sad
                    ...
                    {0xFEE2, {0x0645}},
                    {0xFEE3, {0x0645}},
                    {0xFEE4, {0x0645}}, // م Meem
                    {0xFEE5, {0x0646}},
                    {0xFEE6, {0x0646}},
                    {0xFEE7, {0x0646}},
                    {0xFEE8, {0x0646}}, // ن Noon
                    {0xFEE9, {0x0647}},
                    {0xFEEA, {0x0647}},
                    {0xFEEB, {0x0647}},
                    {0xFEEC, {0x0647}}, // ه Heh
                    ...
                    {0xFEF6, {0x0644, 0x0622}}, // لآ
                    {0xFEF7, {0x0644, 0x0623}},
                    {0xFEF8, {0x0644, 0x0623}}, // لأ
                    {0xFEF9, {0x0644, 0x0625}},
                    {0xFEFA, {0x0644, 0x0625}}, // لإ
                    {0xFEFB, {0x0644, 0x0627}},
                    {0xFEFC, {0x0644, 0x0627}}, // لا
                };
            ...
            static uint8_t getCombiningClass(uint32_t cp)
            {
                ...
                {
                case 0x064B:
                    return CombiningClass::ARABIC_FATHATAN;
                case 0x064C:
                    return CombiningClass::ARABIC_DAMMATAN;
                case 0x064D:
                    return CombiningClass::ARABIC_KASRATAN;
                case 0x064E:
                    return CombiningClass::ARABIC_FATHA;
                case 0x064F:
                    return CombiningClass::ARABIC_DAMMA;
                case 0x0650:
                    return CombiningClass::ARABIC_KASRA;
                case 0x0651:
                    return CombiningClass::ARABIC_SHADDA;
                case 0x0652:
                    return CombiningClass::ARABIC_SUKUN;
                case 0x0670:
                    return CombiningClass::ARABIC_SUPERSCRIPT_ALEF;
                default:
                    return CombiningClass::NOT_REORDERED;
                }
            }
