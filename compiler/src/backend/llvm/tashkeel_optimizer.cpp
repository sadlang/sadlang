...
namespace sad
{
    namespace optimizer
    {
        ...
        struct CharTashkeel
        {
            ...
            CharTashkeel()
                : primary(TashkeelType::NONE), secondary(TashkeelType::NONE), hasSuperscriptAlef(false)
            {
            }
            ...
            uint8_t compress4Bit() const
            {
                ...
                if (secondary == TashkeelType::SHADDA)
                {
                    ...
                    switch (primary)
                    {
                    case TashkeelType::FATHA:
                        return 9;
                    case TashkeelType::DAMMA:
                        return 10;
                    case TashkeelType::KASRA:
                        return 11;
                    case TashkeelType::FATHATAN:
                        return 12;
                    case TashkeelType::DAMMATAN:
                        return 13;
                    case TashkeelType::KASRATAN:
                        return 14;
                    default:
                        return 5; // شدة فقط
                    }
            ...
            static CharTashkeel decompress4Bit(uint8_t value)
            {
                ...
                if (value >= 9 && value <= 14)
                {
                    ...
                    {
                    case 9:
                        result.primary = TashkeelType::FATHA;
                        break;
                    case 10:
                        result.primary = TashkeelType::DAMMA;
                        break;
                    case 11:
                        result.primary = TashkeelType::KASRA;
                        break;
                    case 12:
                        result.primary = TashkeelType::FATHATAN;
                        break;
                    case 13:
                        result.primary = TashkeelType::DAMMATAN;
                        break;
                    case 14:
                        result.primary = TashkeelType::KASRATAN;
                        break;
                    }
                }
                else if (value == 15)
        ...
        public:
            ...
            static TashkeelType codepointToType(uint32_t cp)
            {
                switch (cp)
                {
                case TashkeelCodepoints::FATHA:
                    return TashkeelType::FATHA;
                case TashkeelCodepoints::DAMMA:
                    return TashkeelType::DAMMA;
                case TashkeelCodepoints::KASRA:
                    return TashkeelType::KASRA;
                case TashkeelCodepoints::SUKUN:
                    return TashkeelType::SUKUN;
                case TashkeelCodepoints::SHADDA:
                    return TashkeelType::SHADDA;
                case TashkeelCodepoints::FATHATAN:
                    return TashkeelType::FATHATAN;
                case TashkeelCodepoints::DAMMATAN:
                    return TashkeelType::DAMMATAN;
                case TashkeelCodepoints::KASRATAN:
                    return TashkeelType::KASRATAN;
                case TashkeelCodepoints::SUPERSCRIPT_ALEF:
                    return TashkeelType::SUPERSCRIPT_ALEF;
                default:
                    return TashkeelType::NONE;
                }
            }
            ...
            static uint32_t typeToCodepoint(TashkeelType type)
            {
                ...
                {
                case TashkeelType::FATHA:
                    return TashkeelCodepoints::FATHA;
                case TashkeelType::DAMMA:
                    return TashkeelCodepoints::DAMMA;
                case TashkeelType::KASRA:
                    return TashkeelCodepoints::KASRA;
                case TashkeelType::SUKUN:
                    return TashkeelCodepoints::SUKUN;
                case TashkeelType::SHADDA:
                    return TashkeelCodepoints::SHADDA;
                case TashkeelType::FATHATAN:
                    return TashkeelCodepoints::FATHATAN;
                case TashkeelType::DAMMATAN:
                    return TashkeelCodepoints::DAMMATAN;
                case TashkeelType::KASRATAN:
                    return TashkeelCodepoints::KASRATAN;
                case TashkeelType::SUPERSCRIPT_ALEF:
                    return TashkeelCodepoints::SUPERSCRIPT_ALEF;
                default:
                    return 0;
                }
            }
