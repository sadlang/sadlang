...
namespace
{
    ...
    // (AR) [توحيد min/max — اللا-موقَّع] معامِلا طبيعي64 كلاهما صريحٌ ⇒ مقارنةٌ لا-موقَّعة (cmovb/cmova ·
    ...
    const std::string kSrcUMinUnsigned =
        "\xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9\x20\xD8\xB1\xD8\xA6\xD9\x8A\xD8\xB3\xD9\x8A\xD8\xA9\x28\x29\x0A"
        "\x20\x20\x20\x20\xD8\xB7\xD8\xA8\xD9\x8A\xD8\xB9\xD9\x8A\x36\x34\x20\xD9\x83\xD8\xA8\xD9\x8A\xD8\xB1\x20\x3D\x20\x31\x38\x34\x34\x36\x37\x34\x34\x30\x37\x33\x37\x30\x39\x35\x35\x31\x36\x31\x35\x0A"
        "\x20\x20\x20\x20\xD8\xB7\xD8\xA8\xD9\x8A\xD8\xB9\xD9\x8A\x36\x34\x20\xD8\xB5\xD8\xBA\xD9\x8A\xD8\xB1\x20\x3D\x20\x34\x32\x0A"
    ...
    const std::string kSrcUMaxUnsigned =
        "\xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9\x20\xD8\xB1\xD8\xA6\xD9\x8A\xD8\xB3\xD9\x8A\xD8\xA9\x28\x29\x0A"
        "\x20\x20\x20\x20\xD8\xB7\xD8\xA8\xD9\x8A\xD8\xB9\xD9\x8A\x36\x34\x20\xD9\x83\xD8\xA8\xD9\x8A\xD8\xB1\x20\x3D\x20\x39\x32\x32\x33\x33\x37\x32\x30\x33\x36\x38\x35\x34\x37\x37\x35\x38\x35\x30\x0A"
        "\x20\x20\x20\x20\xD8\xB7\xD8\xA8\xD9\x8A\xD8\xB9\xD9\x8A\x36\x34\x20\xD8\xB5\xD8\xBA\xD9\x8A\xD8\xB1\x20\x3D\x20\x31\x30\x30\x0A"
    ...
    // (AR) طباعةُ أكبر(طبيعي64، طبيعي64): نوعُ نتيجةِ أكبر (عبر resolveSurfaceType، الفرعُ
    //      المُضاف) يجب أن يكونَ طبيعي64، فيَبصمُ مسارُ الطباعةِ التنسيقَ اللا-موقَّع (%llu)
    ...
    // (AR) فرعُ مقارنةٍ لا-موقَّع مباشر: كبير=2^64-1 طبيعي64. إذا (كبير > حد) حيث حدٌّ طبيعي64=100.
    ...
    const std::string kSrcUCmpBranch =
        "\xD8\xAF\xD8\xA7\xD9\x84\xD8\xA9\x20\xD8\xB1\xD8\xA6\xD9\x8A\xD8\xB3\xD9\x8A\xD8\xA9\x28\x29\x0A"
        "\x20\x20\x20\x20\xD8\xB7\xD8\xA8\xD9\x8A\xD8\xB9\xD9\x8A\x36\x34\x20\xD9\x83\xD8\xA8\xD9\x8A\xD8\xB1\x20\x3D\x20\x31\x38\x34\x34\x36\x37\x34\x34\x30\x37\x33\x37\x30\x39\x35\x35\x31\x36\x31\x35\x0A"
        "\x20\x20\x20\x20\xD8\xB7\xD8\xA8\xD9\x8A\xD8\xB9\xD9\x8A\x36\x34\x20\xD8\xAD\xD8\xAF\x20\x3D\x20\x31\x30\x30\x0A"
    ...
    // (AR) فرعُ نتيجةِ أكبر المتداخلة: أكبر(كبير،حد) يجب أن يحملَ طبيعي64 (resolveSurfaceType)
    //      إلى مقارنةٍ لا-موقَّعةٍ بحدٍّ طبيعي64. لا-موقَّعًا: أكبر=2^64-1 > 100 ⇒ 42؛ لو انحدرَ
...
// (AR) [توحيد min/max — اللا-موقَّع] معامِلا طبيعي64 ⇒ مقارنةٌ لا-موقَّعة. القيمُ ذاتُ البتِّ العالي
