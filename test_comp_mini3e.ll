; ModuleID = 'test_comp_mini3e'
source_filename = "test_comp_mini3e"
...
@str.const = private unnamed_addr constant [9 x i8] c"\D8\A8\D8\B9\D8\AF: \00", align 1
...
entry:
  ...
  store i64 99, ptr %arr.elem11, align 8
  ...
  %arr.get = load i64, ptr %arr.elem16, align 8
  %strbuf = alloca i8, i64 32, align 1
  %0 = call i32 (ptr, ptr, ...) @sprintf(ptr %strbuf, ptr @int.fmt, i64 %arr.get)
