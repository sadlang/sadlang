...
%"class.\D8\A7\D8\AE\D8\AA\D8\A8\D8\A7\D8\B1" = type { i64 }
...
entry:
  ...
  store i64 %"%\D8\A7\D8\B3\D9\85.load", ptr %"\D8\A7\D9\84\D8\A7\D8\B3\D9\85_gep", align 8
  ret void
}
...
entry:
  ...
  %"%self.objptr" = inttoptr i64 %"%self.ptrval" to ptr
  %"\D8\A7\D9\84\D8\A7\D8\B3\D9\85_gep" = getelementptr inbounds %"class.\D8\A7\D8\AE\D8\AA\D8\A8\D8\A7\D8\B1", ptr %"%self.objptr", i32 0, i32 0
  %"\D8\A7\D9\84\D8\A7\D8\B3\D9\85.val" = load i64, ptr %"\D8\A7\D9\84\D8\A7\D8\B3\D9\85_gep", align 8
  %strbuf = alloca i8, i64 32, align 1
  %0 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %strbuf, i64 32, ptr @int.fmt, i64 %"\D8\A7\D9\84\D8\A7\D8\B3\D9\85.val")
...
entry:
  ...
  call void @"\D8\A7\D8\AE\D8\AA\D8\A8\D8\A7\D8\B1.\D8\A8\D9\86\D8\A7\D8\A1"(i64 %arg.ptrtoint, i64 ptrtoint (ptr @str.const.3 to i64))
  %obj.ptrtoint = ptrtoint ptr %"%3" to i64
  store i64 %obj.ptrtoint, ptr %"%\D8\AA", align 8
  %"%\D8\AA.load" = load i64, ptr %"%\D8\AA", align 8
  call void @"\D8\A7\D8\AE\D8\AA\D8\A8\D8\A7\D8\B1.\D8\A7\D8\B9\D8\B1\D8\B6"(i64 %"%\D8\AA.load")
  ret void
}
