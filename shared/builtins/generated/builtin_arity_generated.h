    ...
    namespace Builtins
    {
        namespace Arity
        {
            ...
            namespace ByName
            {
                ...
                ///        · فك_تشفير
                ///        · هاش
                ///      لا تُخمَّن رتبتُها ولا تُفرَض — لا عقدَ لها.
                ///
                ...
                ///        · ارسم_خط — التنفيذُ يقرأُ وسيطًا فوقَ الأعلى المُعلَن
                ///        · ارسم_مستطيل — التنفيذُ يقرأُ وسيطًا فوقَ الأعلى المُعلَن
                ///        · تأكد_أكبر — التنفيذُ يقرأُ وسيطًا فوقَ الأعلى المُعلَن
                struct NamedRange
                {
                    const char *name;
                    Range range;
                ...
                inline constexpr NamedRange TABLE[] = {
                    {"acpi_ecam_قاعدة", {0, 2}},
                    {"acpi_إصدار", {0, 0}},
                    {"acpi_إعادة_تشغيل", {0, 0}},
                    {"acpi_تأخير", {1, 1}},
                    {"acpi_تعطيل", {0, 0}},
                    {"acpi_تفعيل", {0, 0}},
                    {"acpi_تهيئة", {0, 0}},
                    {"acpi_تهيئة_من_rsdp", {1, 1}},
                    {"acpi_عدد_معالجات", {0, 0}},
                    {"acpi_عنوان_apic", {0, 0}},
                    {"acpi_قراءة_مؤقت", {0, 0}},
                    {"acpi_مؤقت_32بت", {0, 0}},
                    {"acpi_نوم", {1, 1}},
                    ...
                    {"apic_أرسل_sipi", {2, 2}},
                    {"apic_أرسل_للكل", {1, 2}},
                    {"apic_أولوية_مهمة", {1, 1}},
                    {"apic_إلغاء_قناع_irq", {1, 1}},
                    {"apic_إيقاف_مؤقت", {0, 0}},
                    {"apic_انتظر_تسليم", {0, 0}},
                    {"apic_بدء_مؤقت", {1, 1}},
                    {"apic_تهيئة_io", {3, 3}},
                    {"apic_تهيئة_مؤقت", {0, 3}},
                    {"apic_عداد_مؤقت", {0, 0}},
                    ...
                    {"uefi_إصدار", {0, 0}},
                    {"uefi_إصدار_بائع", {0, 0}},
                    {"uefi_إعادة_تشغيل", {1, 1}},
                    {"uefi_إغلاق_ملف", {1, 1}},
                    {"uefi_إنهاء_خدمات_إقلاع", {1, 1}},
                    {"uefi_استعلام_وضع", {1, 1}},
                    {"uefi_الوقت", {0, 0}},
                    {"uefi_بائع", {0, 0}},
                    {"uefi_بحث_بروتوكول", {1, 1}},
                    {"uefi_تحرير_صفحات", {2, 2}},
                    {"uefi_تحرير_كتلة", {1, 1}},
                    {"uefi_تخصيص_صفحات", {3, 3}},
                    {"uefi_تخصيص_كتلة", {2, 2}},
                    {"uefi_تعيين_وضع_رسوميات", {1, 1}},
                    {"uefi_تعيين_وقت", {6, 6}},
                    {"uefi_تقرير", {0, 0}},
                    {"uefi_تهيئة", {0, 2}},
                    {"uefi_تهيئة_رسوميات", {0, 0}},
                    {"uefi_حجم_إطار", {0, 0}},
                    {"uefi_خدمات_إقلاع_منتهية", {0, 0}},
                    {"uefi_خريطة_ذاكرة", {0, 0}},
                    {"uefi_ذاكرة_متاحة", {0, 0}},
                    {"uefi_رسم_مستطيل", {7, 7}},
                    {"uefi_عدد_أوضاع_رسوميات", {0, 0}},
                    {"uefi_عنوان_إطار", {0, 0}},
                    {"uefi_فتح_ملف", {2, 3}},
                    {"uefi_فتح_وحدة_تخزين", {0, 0}},
                    {"uefi_قراءة_متغير", {1, 1}},
                    {"uefi_قراءة_ملف", {1, 2}},
                    {"uefi_كتابة_متغير", {2, 3}},
                    {"uefi_كتابة_ملف", {3, 3}},
                    {"uefi_معلومات_ملف", {1, 1}},
                    {"uefi_مفتاح_خريطة", {0, 0}},
                    {"uefi_ملء_شاشة", {3, 3}},
                    {"uefi_هل_مهيأ", {0, 0}},
                    {"uefi_وضع_رسوميات_حالي", {0, 0}},
                    {"آمن", {1, 1}},
                    {"أرجون2", {4, 4}},
                    {"أرسل_رسالة", {4, 4}},
                    {"أرسل_عبر_وصلة", {2, 2}},
                    ...
                    {"أكبر", {2, 2}},
                    {"أنشئ_خادم", {1, 1}},
                    {"أنشئ_خيط", {1, UNBOUNDED}},
                    {"أنشئ_مجلد", {1, 2}},
                    {"أنشئ_مهمة", {1, UNBOUNDED}},
                    {"أوف_مستقبل", {2, 2}},
                    {"أوقف_الخادم", {1, 1}},
                    {"إزالة_عنصر", {2, 2}},
                    {"إشارة", {1, 1}},
                    ...
                    {"احذف_مورد", {2, 2}},
                    {"احصل_مستقبل", {1, 1}},
                    {"ارسل_مقاطعة_معالج", {2, 2}},
                    {"ارسل_نهاية_مقاطعة", {0, 0}},
                    {"ارسم", {1, 1}},
                    {"ارسم_نص", {3, 3}},
                    {"ارسم_نقطة", {3, 3}},
                    {"ازل_تشكيل", {1, 1}},
                    ...
                    {"استقبل_قناة", {1, 1}},
                    {"اسرد_مجلد", {1, 1}},
                    {"اسمح_بالوصول_الخارجي", {2, 2}},
                    {"اشتق_مفتاح", {4, 4}},
                    {"اشتق_مفتاح_عام_x25519", {1, 1}},
                    {"اشتق_مفتاح_عام_توقيع", {1, 1}},
                    {"اشتق_مفتاح_مرور", {3, 3}},
                    {"اضبط_مؤقت_متحكم", {2, 2}},
                    {"اطفئ", {0, 0}},
                    {"اعد_حجز", {2, 2}},
                    ...
                    {"افتح_ملف_نواة", {1, 2}},
                    {"افتح_وصفا", {2, 2}},
                    {"افرغ_ذاكرة_ترجمة", {0, 0}},
                    {"افصل_قرص", {1, 1}},
                    {"اقبل_متصل", {1, 1}},
                    {"اقتطاع", {1, 1}},
                    {"اقرأ_اعدادات_ناقل", {4, 4}},
                    {"اقرأ_بايتات", {1, 1}},
                    {"اقرأ_ذاكرة", {1, 1}},
                    {"اقرأ_ذاكرة16", {1, 1}},
                    {"اقرأ_ذاكرة32", {1, 1}},
                    ...
                    {"تقرير_المعالج", {0, 0}},
                    {"تقرير_ترحيل", {0, 0}},
                    {"تقرير_ذاكرة_نواة", {0, 0}},
                    {"تقرير_شاشة", {0, 0}},
                    {"تقرير_طاقة", {0, 0}},
                    {"تقرير_مؤقت_دقيق", {0, 0}},
                    {"تقرير_متحكم_مقاطعات", {0, 0}},
                    {"تقرير_مجدول", {0, 0}},
                    {"تقرير_مقاطعات", {0, 0}},
                    {"تقرير_ملفات", {0, 0}},
                    {"تقرير_ناقل", {0, 0}},
                    ...
                    {"حدد_الانتظار", {2, 2}},
                    {"حدد_الموقع", {2, 2}},
                    {"حدد_انتظار_الإرسال", {2, 2}},
                    {"حدد_انتظار_الاستقبال", {2, 2}},
                    {"حدد_وضع_منفذ", {2, 2}},
                    {"حرر", {1, 1}},
                    {"حرر_عنوان", {1, 1}},
                    {"حرر_فيزيائي", {1, 1}},
                    ...
                    {"خالف", {2, 2}},
                    {"خريطة_اجلب_رقم", {2, 2}},
                    {"خريطة_اجلب_منطقي", {2, 2}},
                    {"خريطة_اجلب_نص", {2, 2}},
                    {"خريطة_احذف", {2, 2}},
                    {"خريطة_احصل", {2, 3}},
                    {"خريطة_تحتوي", {2, 2}},
                    {"خريطة_حجم", {1, 1}},
                    {"خريطة_ذاكرة_اقلاع", {0, 0}},
                    {"خريطة_عين", {3, 3}},
                    {"خريطة_قيم", {1, 1}},
                    {"خريطة_مفاتيح", {1, 1}},
                    {"خزن_ذري", {2, 2}},
