...
std::string ConceptExplanation::format(bool useArabic) const {
    ...
    oss << "\n\xF0\x9F\x93\x9A " << (useArabic ? concept : conceptEn) << "\n";
    oss << "   ====================================================\n";
...
void ConceptsDatabase::initializeConcepts() {
    // Types concept
    {
        ...
        c.concept = "\xD8\xA7\xD9\x84\xD8\xA3\xD9\x86\xD9\x88\xD8\xA7\xD8\xB9 (Types)";
        c.conceptEn = "Types";
    ...
    {
        ConceptExplanation c;
        c.concept = "\xD8\xA7\xD9\x84\xD9\x85\xD8\xAA\xD8\xBA\xD9\x8A\xD8\xB1\xD8\xA7\xD8\xAA (Variables)";
    ...
    {
        ConceptExplanation c;
        c.concept = "\xD8\xA7\xD9\x84\xD8\xAF\xD9\x88\xD8\xA7\xD9\x84 (Functions)";
    ...
    {
        ConceptExplanation c;
        c.concept = "\xD8\xA7\xD9\x84\xD8\xB4\xD8\xB1\xD9\x88\xD8\xB7 (Conditions)";
    ...
    {
        ConceptExplanation c;
        c.concept = "\xD8\xA7\xD9\x84\xD8\xAD\xD9\x84\xD9\x82\xD8\xA7\xD8\xAA (Loops)";
        c.conceptEn = "Loops";        
