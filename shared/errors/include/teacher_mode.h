...
#include "explanation_level.h" // (AR) ExplanationLevel + Language موحَّدة / (EN) Unified ExplanationLevel + Language
#include <string>
#include <vector>
...
namespace Sad
{
    namespace Errors
    {
        ...
        // ═══════════════════════════════════════════════════════════════════════
        // (AR) ExplanationLevel نُقلت إلى explanation_level.h — هذا الملف يستوردها
        // (EN) ExplanationLevel moved to explanation_level.h — this file re-exports
