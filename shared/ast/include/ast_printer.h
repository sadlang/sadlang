...
namespace Sad
{
    namespace AST
    {
        ...
        public:
            ...
            void visitSelectCase(SelectCase &stmt) override;
            ...
            // (AR) امتدادات وماكروز وأنواع مستعارة وتفكيك صفوف
            ...
            void visitTypeAliasDecl(TypeAliasDecl &decl) override;
            void visitTupleDestructureStmt(TupleDestructureStmt &stmt) override;

            // (AR) عقد الواجهات التصريحية / (EN) Declarative UI nodes
            void visitUIDeclaration(UIDeclarationNode &node) override;
            void visitUIWidgetExpr(UIWidgetExprNode &node) override;
