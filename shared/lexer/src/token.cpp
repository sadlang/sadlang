...
namespace Sad
{
    namespace Lexer
    {
        ...
        std::string Token::typeToString(TokenType type)
        {
            ...
            case TokenType::KEYWORD_INHERITS:
                return "KEYWORD_INHERITS"; // spec 03_oop.md §1,2
            case TokenType::KEYWORD_END:
                return "KEYWORD_END"; // spec 03_oop.md §1
            ...
            case TokenType::KEYWORD_PACKED:
                return "KEYWORD_PACKED";
            case TokenType::KEYWORD_NORETURN:
                return "KEYWORD_NORETURN";
            case TokenType::KEYWORD_NAKED:
                return "KEYWORD_NAKED";
            case TokenType::KEYWORD_REGISTER:
                return "KEYWORD_REGISTER";
            case TokenType::KEYWORD_SECTION:
            ...
            case TokenType::OP_FLOOR_DIVIDE_ASSIGN:
                return "OP_FLOOR_DIVIDE_ASSIGN";
            ...
            // عامل الأنبوب
            case TokenType::OP_PIPE_ARROW:
                return "OP_PIPE_ARROW";
            ...
            case TokenType::COMMA:
                return "COMMA";
            case TokenType::ARABIC_COMMA:
                return "ARABIC_COMMA"; // U+060C spec 03_oop.md §1
            case TokenType::SEMICOLON:
                return "SEMICOLON";
            case TokenType::ARABIC_SEMICOLON:
                return "ARABIC_SEMICOLON"; // U+061B spec 03_oop.md §1
            ...
            case TokenType::LIFETIME:
                return "LIFETIME";
            case TokenType::KEYWORD_REQUIRES:
                return "KEYWORD_REQUIRES";
            case TokenType::KEYWORD_ENSURES:
                return "KEYWORD_ENSURES";
            case TokenType::KEYWORD_CONTRACT:
                return "KEYWORD_CONTRACT";
