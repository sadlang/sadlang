...
const std::vector<KeywordEntry>& allEntries() {
    static const std::vector<KeywordEntry> entries = {
        ...
        { "سمة", TokenType::KEYWORD_TRAIT, KeywordCategory::CONTEXTUAL, false, {"واجهة"}, {"block_opener"}, "trait" },
        ...
        { "واجهة_تصريحية", TokenType::KEYWORD_UI_DECL, KeywordCategory::CONTEXTUAL, false, {}, {}, "ui_decl" },
