...
inline const char* ownershipPolicyToArabic(OwnershipPolicy policy) {
    switch (policy) {
        case OwnershipPolicy::OWNED:       return "مملوك";
        case OwnershipPolicy::BORROWED:    return "مُستعار";
        case OwnershipPolicy::SHARED:      return "مشترك";
        case OwnershipPolicy::TRANSFERRED: return "منقول";
    }
    return "غير معروف";
}
