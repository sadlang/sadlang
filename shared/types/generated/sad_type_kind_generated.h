...
namespace Sad
{
    namespace Types
    {
         ...
         *
         * (AR) العدد: 9 — يستهلكها مزوّد الرموز الدلاليّة لتلوينها أنواعًا.
         * (EN) 9 names — consumed by the semantic-tokens provider.
         */
        inline constexpr std::array<std::string_view, 9> SURFACE_TYPE_NAMES = {{
        ...
        {
            if (word == "\xd9\x81\xd8\xb1\xd8\xa7\xd8\xba") return "\xd9\x86\xd9\x88\xd8\xb9\x20\xd8\xa7\xd9\x84\xd8\xa5\xd8\xb1\xd8\xac\xd8\xa7\xd8\xb9\x20\xd8\xa7\xd9\x84\xd9\x81\xd8\xa7\xd8\xb1\xd8\xba\x20\xe2\x80\x94\x20\xd9\x84\xd8\xa7\x20\xd9\x82\xd9\x8a\xd9\x85\xd8\xa9"; // فراغ
