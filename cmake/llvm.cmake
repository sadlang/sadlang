...
if(NOT LLVM_FOUND)
    ...
    message(WARNING "   cmake -DLLVM_DIR=C:/LLVM/lib/cmake/llvm ..")
    set(ENABLE_LLVM_BACKEND OFF PARENT_SCOPE)
    return()
endif()
...
# تصدير المتغير للملف الأب / Export to parent scope
