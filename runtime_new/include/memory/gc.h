 ...
 * ================================
 * 
 * نظام Mark & Sweep لجمع القمامة التلقائي
 * Mark & Sweep garbage collector for automatic memory management
 * 
 * الخوارزمية / Algorithm:
 * 1. Mark Phase: تعليم جميع الكائنات القابلة للوصول
 * 2. Sweep Phase: تحرير الكائنات غير المعلمة
 * 3. Compact Phase (اختياري): ضغط الذاكرة
 * 
