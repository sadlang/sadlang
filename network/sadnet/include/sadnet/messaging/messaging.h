...
// (EN) End-to-End Encrypted messaging with Double Ratchet// المكون: network/sadnet (الرسائل المشفرة E2EE)
// المسار: network/sadnet/include/sadnet/messaging/messaging.h// ═══════════════════════════════════════════════════════════════════
