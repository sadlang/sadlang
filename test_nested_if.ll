; ModuleID = 'test_nested_if.sad'
source_filename = "test_nested_if.sad"
...
@9 = private unnamed_addr constant [11 x i8] c"\D8\A7\D8\AB\D9\86\D8\A7\D9\86\00", align 1
...
then_3:                                           ; preds = %else_2
  ...
  %cmpgttmp = icmp sgt i64 %auto.load4, 5
  br i1 %cmpgttmp, label %then_6, label %merge_7

else_5:                                           ; preds = %else_2
  %auto.load5 = load i64, ptr %alloca, align 8
  %cmpeqtmp6 = icmp eq i64 %auto.load5, 2
  br i1 %cmpeqtmp6, label %then_8, label %merge_9

merge_4:                                          ; preds = %merge_9, %merge_7
  br label %merge_1
