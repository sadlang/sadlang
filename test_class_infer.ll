; ModuleID = 'test_class_infer'
source_filename = "test_class_infer"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%"class.\D8\B7\D8\A7\D9\84\D8\A8" = type { ptr, i64, i64 }
...
@str.const.3 = private unnamed_addr constant [9 x i8] c"\D8\A3\D8\AD\D9\85\D8\AF\00", align 1

define void @"\D8\B7\D8\A7\D9\84\D8\A8.\D8\A8\D9\86\D8\A7\D8\A1"(i64 %self, i64 %"\D8\A7\D8\B3\D9\85", i64 %"\D8\B9\D9\85\D8\B1", i64 %"\D9\85\D8\B9\D8\AF\D9\84") {
entry:
  %"\D9\85\D8\B9\D8\AF\D9\844" = alloca i64, align 8
  store i64 %"\D9\85\D8\B9\D8\AF\D9\84", ptr %"\D9\85\D8\B9\D8\AF\D9\844", align 8
  ...
  %"%self.ptrval5" = load i64, ptr %self1, align 8
  %"%self.objptr6" = inttoptr i64 %"%self.ptrval5" to ptr
  %"\D8\A7\D9\84\D8\B9\D9\85\D8\B1_gep" = getelementptr inbounds %"class.\D8\B7\D8\A7\D9\84\D8\A8", ptr %"%self.objptr6", i32 0, i32 1
  store i64 %"%\D8\B9\D9\85\D8\B1.load", ptr %"\D8\A7\D9\84\D8\B9\D9\85\D8\B1_gep", align 8
  %"%\D9\85\D8\B9\D8\AF\D9\84.load" = load i64, ptr %"\D9\85\D8\B9\D8\AF\D9\844", align 8
  %"%self.ptrval7" = load i64, ptr %self1, align 8
  %"%self.objptr8" = inttoptr i64 %"%self.ptrval7" to ptr
  %"\D8\A7\D9\84\D9\85\D8\B9\D8\AF\D9\84_gep" = getelementptr inbounds %"class.\D8\B7\D8\A7\D9\84\D8\A8", ptr %"%self.objptr8", i32 0, i32 2
  store i64 %"%\D9\85\D8\B9\D8\AF\D9\84.load", ptr %"\D8\A7\D9\84\D9\85\D8\B9\D8\AF\D9\84_gep", align 8
  ret void
}

define void @"\D8\B7\D8\A7\D9\84\D8\A8.\D8\B9\D8\B1\D8\B6"(i64 %self) {
entry:
  %self1 = alloca i64, align 8
  store i64 %self, ptr %self1, align 8
  %"%self.ptrval" = load i64, ptr %self1, align 8
  ...
  %"\D8\A7\D9\84\D8\B9\D9\85\D8\B1_gep" = getelementptr inbounds %"class.\D8\B7\D8\A7\D9\84\D8\A8", ptr %"%self.objptr3", i32 0, i32 1
  %"\D8\A7\D9\84\D8\B9\D9\85\D8\B1.val" = load i64, ptr %"\D8\A7\D9\84\D8\B9\D9\85\D8\B1_gep", align 8
  %strbuf = alloca i8, i64 32, align 1
  %3 = call i32 (ptr, ptr, ...) @sprintf(ptr %strbuf, ptr @int.fmt, i64 %"\D8\A7\D9\84\D8\B9\D9\85\D8\B1.val")
...
entry:
  ...
  %"%6" = alloca %"class.\D8\B7\D8\A7\D9\84\D8\A8", align 8
  %arg.ptrtoint = ptrtoint ptr %"%6" to i64
  call void @"\D8\B7\D8\A7\D9\84\D8\A8.\D8\A8\D9\86\D8\A7\D8\A1"(i64 %arg.ptrtoint, i64 ptrtoint (ptr @str.const.3 to i64), i64 20, i64 3)
  %obj.ptrtoint = ptrtoint ptr %"%6" to i64
  store i64 %obj.ptrtoint, ptr %"%\D8\B7", align 8
  %"%\D8\B7.load" = load i64, ptr %"%\D8\B7", align 8
  call void @"\D8\B7\D8\A7\D9\84\D8\A8.\D8\B9\D8\B1\D8\B6"(i64 %"%\D8\B7.load")
  ret void
}
