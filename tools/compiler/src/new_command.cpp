...
private:
    ...
    void initializeTemplates() {
        ...
        // ═══════════════════════════════════════════════════════════════
        {
            ...
            t.files.push_back({"src/main.sad", R"(// ═══════════════════════════════════════════════════════════
//                    مشروع سعد الجديد
// ═══════════════════════════════════════════════════════════
...
دالة رئيسية():
    ...
    أرجع 0
        ...
        // ═══════════════════════════════════════════════════════════════
        {
            ...
            t.files.push_back({"src/lib.sad", R"(// ═══════════════════════════════════════════════════════════
//                       مكتبة سعد
// ═══════════════════════════════════════════════════════════
...
عام ثابت الاسم = "مكتبتي"
            ...
            t.files.push_back({"tests/test_lib.sad", R"(// اختبارات المكتبة
...
private:
    ...
    void createPackageToml(const fs::path& projectPath, const NewCommandOptions& options) {
        ...
        if (options.isLibrary) {
            file << "الهدف = \"مكتبة\"\n";
            file << "المدخل = \"src/lib.sad\"\n";
        } else {
            file << "الهدف = \"تنفيذي\"\n";
            file << "المدخل = \"src/main.sad\"\n";
        }
        file << "\n";
