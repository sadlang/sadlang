...
// إنشاء وتدمير
#define أنشئ_شبكة()                         أنشئ_شبكة()
#define دمر_شبكة(ش)                         دمر_شبكة(ش)

// طلبات HTTP
#define أرسل_طلب(ش, رابط)                   أرسل_طلب(ش, رابط)
#define أرسل_طلب_مخصص(ش, إعدادات)           أرسل_طلب_مخصص(ش, إعدادات)
#define أرسل_بوست(ش, رابط, جسم)             أرسل_POST(ش, رابط, جسم)
#define أرسل_بوت(ش, رابط, جسم)              أرسل_PUT(ش, رابط, جسم)
#define أرسل_حذف(ش, رابط)                   أرسل_DELETE(ش, رابط)

// طلبات غير متزامنة
#define أرسل_طلب_متزامن(ش, رابط, دالة, بيانات)  أرسل_طلب_متزامن(ش, رابط, دالة, بيانات)

// إعدادات
#define عيّن_ترويسة(ش, م, ق)               عيّن_ترويسة_افتراضية(ش, م, ق)
#define عيّن_مهلة(ش, مللي)                  عيّن_مهلة_الاتصال(ش, مللي)
#define حرر_استجابة(ر)                      حرر_استجابة(ر)

// تحميل
#define حمّل_ملف(ش, رابط, مسار)             حمّل_ملف(ش, رابط, مسار)

// ═══════════════════════════════════════════════════════════════════════════════
//  خدمات النظام — الملفات
// ═══════════════════════════════════════════════════════════════════════════════

#include "sad_files.h"

// إنشاء وتدمير
#define أنشئ_ملفات(مسار)                    أنشئ_نظام_ملفات(مسار)
#define دمر_ملفات(م)                        دمر_نظام_ملفات(م)

// قراءة وكتابة نصية
#define اقرأ_نصي(م, مسار)                   اقرأ_ملف_نصي(م, مسار)
#define اكتب_نصي(م, مسار, محتوى)            اكتب_ملف_نصي(م, مسار, محتوى)
#define أضف_نص(م, مسار, محتوى)              أضف_لملف(م, مسار, محتوى)

// قراءة وكتابة ثنائية  
#define اقرأ_ثنائي(م, مسار, حجم)            اقرأ_ملف_ثنائي(م, مسار, حجم)
#define اكتب_ثنائي(م, مسار, بيانات, حجم)    اكتب_ملف_ثنائي(م, مسار, بيانات, حجم)

// عمليات الملفات
#define موجود(م, مسار)                      ملف_موجود(م, مسار)
#define احذف(م, مسار)                       احذف_ملف(م, مسار)
#define انقل(م, قديم, جديد)                 انقل_ملف(م, قديم, جديد)
#define انسخ(م, مصدر, هدف)                  انسخ_ملف(م, مصدر, هدف)

// مجلدات
#define أنشئ_مجلد(م, مسار)                  أنشئ_مجلد(م, مسار)
#define استعراض(م, مسار)                     استعرض_مجلد(م, مسار)

// مسارات
#define ادمج(أساس, فرعي)                    ادمج_مسار(أساس, فرعي)

// ═══════════════════════════════════════════════════════════════════════════════
//  خدمات النظام — قواعد البيانات
// ═══════════════════════════════════════════════════════════════════════════════

#include "sad_database.h"

// فتح وإغلاق
#define افتح_قاعدة(مسار)                    افتح_قاعدة_بيانات(مسار)
#define أغلق_قاعدة(ق)                       أغلق_قاعدة_بيانات(ق)

// تنفيذ
#define نفذ(ق, أمر)                         نفذ_أمر(ق, أمر)
#define استعلم(ق, أمر)                       نفذ_استعلام(ق, أمر)
#define حرر_نتيجة(ن)                        حرر_نتيجة(ن)

// أوامر محضّرة
#define حضّر(ق, أمر)                        حضّر_أمر(ق, أمر)
#define اربط_عدد(أ, ت, ق)                   اربط_عدد(أ, ت, ق)
#define اربط_نص(أ, ت, ق)                    اربط_نص(أ, ت, ق)
#define نفذ_محضّر(أ)                         نفذ_محضّر(أ)
#define دمر_محضّر(أ)                         دمر_محضّر(أ)

// معاملات
#define ابدأ_معاملة(ق)                      ابدأ_معاملة(ق)
#define أكد_معاملة(ق)                       أكد_معاملة(ق)
#define تراجع(ق)                            تراجع_عن_معاملة(ق)

// قراءة القيم
#define قيمة_نص(ن, صف, عمود)                قيمة_عمود_نص(ن, صف, عمود)
#define قيمة_عدد(ن, صف, عمود)               قيمة_عمود_عدد(ن, صف, عمود)

// ═══════════════════════════════════════════════════════════════════════════════
//  تحميل الصور
// ═══════════════════════════════════════════════════════════════════════════════

#define حمّل_صورة(مسار)                     sadui_load_image(مسار)
#define حمّل_صورة_ذاكرة(بيانات, حجم)        sadui_load_image_from_memory(بيانات, حجم)
#define احذف_صورة(معرف)                     sadui_unload_image(معرف)
#define حجم_صورة(معرف, عرض, ارتفاع)        sadui_get_image_size(معرف, عرض, ارتفاع)
#define مكون_صورة(معرف)                     sadui_image(معرف)
#define ارسم_صورة(سياق, معرف, مستطيل)       sadcanvas_draw_image(سياق, معرف, مستطيل)
