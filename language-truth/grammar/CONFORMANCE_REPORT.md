...
- إجمالي الاختبارات: **2928** — تطابق مزدوج: **2927** — تباعد/إخفاق: **0** — متخطًّى: **1**
...
| `001_int64_precision_dual.ص` | ISSUE-INT64-PRECISION | تعمل ✅ |
...
| `001_template_string_arg_compiler.ص` | ISSUE-071 | تكشف ثغرة ❌ (تجاوز المهلة ⏱) |
