...
- إجمالي الاختبارات: **3039** — نجحت: **3019** — تباعد/إخفاق: **1** — متخطًّى: **19**
...
| `gr.adv.template_params` | advanced | 5 | مُغطّاة (المترجّم وحدَه) |
...
| `gr.decl.parameters` | declarations | 56 | مُغطّاة (المترجّم وحدَه) |
...
| `gr.expr.term` | expressions | 81 | مُغطّاة (المترجّم وحدَه) |
