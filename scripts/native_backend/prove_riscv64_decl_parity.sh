...
#        • طبيعي: 2^64−1 و2^63 — المسارُ اللا-موقَّع. كان يطبع «‑1» صامتًا (ع-١)
...
#      المكتوبةُ النوعِ (طبيعي) المصفوفةَ نفسَها بلا مسارٍ ثانٍ يُنسى تحديثُه.
# (AR) ⚠️ وكانت حالتا `طبيعي` مكتوبتَين بالصيغةِ اللاحقةِ «متغير س: طبيعي» —
...
#      الصيغةِ المنصوصةِ «متغير طبيعي س»، والدلالةُ واحدةٌ مقيسةً (‑1 ⇒ 2^64−1 في
...
uint64_max|18446744073709551615|متغير طبيعي س = 18446744073709551615
uint64_high|9223372036854775808|متغير طبيعي س = 9223372036854775808
