...
EXPECT_DIR=7   # (AR) قراءةُ مجلّدٍ ⇒ مصفوفةٌ فارغةٌ لا انهيار. والحالةُ ترجع
#              #      «الطول + ٧» لا الطولَ وحدَه: الصفرُ هو رمزُ النجاحِ الافتراضيُّ
#              #      نفسُه، فلو كان المتوقَّعُ ٠ لَما فرّق الأوراكلُ بين «عُولج
#              #      ‎-EISDIR‎ فكان الطولُ صفرًا» و«لم يُقَس شيءٌ أصلًا».
