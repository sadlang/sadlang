...
#      مُقاسٌ في ٢٠٢٦-٠٩-٠٥: ٢٧ حارسًا (بلا هذا الملفّ)، واحدٌ مُعايَرٌ بسجلٍّ
#      مقروءٍ آليًّا، فالباقي ٢٦.
...
def main() -> int:
    ...
    if drifted:
        ...
        for item in drifted:
            print(f"      · {item}")
        print("      أعِدْه: python scripts/codegen/calibrate_builtin_coverage.py"
