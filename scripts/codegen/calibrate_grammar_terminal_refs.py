...
PROBES = (
    ...
    # (AR) 🔑 **والعطبُ المؤسِّسُ لم يكن صفرًا بل واحدًا من ٢٥١.** فشرطُ «لا
    #      يُساهِمُ بشيء» يمرُّ عليه أخضرَ — أي أنّ الرقعةَ لا تحرسُ عودةَ العطبِ
    #      الذي كُتِبَت له. والمجسُّ يُنقِصُ المصدرَ ولا يُفرِغُه.
    ("⑲ مصدرٌ يُساهِمُ بأقلَّ من أرضيّتِه — رمزُ آلةٍ ٢",
     GUARD_REL, sub("أرضيّة_المصدر = 20".encode("utf-8"),
                    "أرضيّة_المصدر = 44  # zz_probe_raise_floor".encode("utf-8"),
                    residue=True),
     2, _only(_DEAD)),
