...
BASELINE = {
    ...
    # (AR) لافتةُ تحذيرِ الودجات المُهمَلة + ١٩ رسالةَ consume متعدّدةَ الأسطر.
    #      ⚠ الرقم كان «1» قبل حراسة consume — لا لأنّ الدَّين ازداد بل لأنّ الحارسَ
    #      كان أعمى عن المصرف. الملفّ لم يُكنَس أصلًا، ويُكنَس مع ربط
    #      language-truth/ui/widget_catalog_parser.yaml.
    "shared/parser/src/ui/parser_ui.cpp": 20,
}
