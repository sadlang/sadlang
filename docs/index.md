...
| [معمارية الذاكرة الموحَّدة](معمارية_الذاكرة_الموحدة.md) | خطة توحيد الملكية + GC + الأعلام الثلاثة `--gc/--prod/--learn` عبر جميع المسارات |
| [معمارية GC والجذور الديناميكية](معمارية_GC_جذور_ديناميكية.md) | رحلة B-step5b: مؤشرات خام مُدارة بـ GC + RootProvider + ما اكتمل وما تبقى |
