...
> طرفًا زال.
>
> واللامتغيِّرُ الذي يفرضُه الحارسُ اليومَ صيغتُه: **نظامُ المترجّمِ لا
> يربطُ زمنَ التشغيلِ مباشرةً** — لا «لا روابطَ بين محرّكَين». والمجموعةُ
> التي كانت `INTERP` صارت `RUNTIME` في الشفرة، ونُزِعت منها أربعةُ أهدافٍ
> محذوفة.
>
