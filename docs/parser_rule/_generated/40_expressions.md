...
- **الوصف:** أعلى مستوى أسبقية. يشمل القيم الحرفيّة، المتغيّر/تخصيص القالب، التجميع/الصف/السهميّة، المصفوفة/الخريطة الحرفيّة، «هذا»/«الأساس»، «انتظر»/«انشر»، تعبير-إذا، القيمة المطلقة «|x|»، وتعبير الواجهة «اعرض». تمييز «(»: «()» قيمةُ الوحدة، «(x)» تجميع، «(x،...)» صف، «(x) =>» سهميّة. 🔑 و«()» **قيمةٌ حرفيّةٌ لنوعِ «خالي»** لا صفٌّ فارغٌ يُخصَّص في الكومة (2026-09-07): نوعُ الوحدةِ **هو** الصفُّ الفارغُ كما في رست، وقيمتُه واحدةٌ لا تتعدّد — فنسختانِ منها متساويتان، ولا تحملُ عنوانًا. وكان يُخفَّضُ TUPLE_NEW فيُخصَّصُ لكلِّ «()» كائنٌ في الكومة: مقيسٌ أنّ «خالي أ = ()» و«خالي ب = ()» كانا **مختلفَين** داخلَ دالّة، وأنّ «نص(())» يطبعُ عنوانًا. والقيمةُ الواحدةُ لا يجوز أن تتعدّدَ بالتخصيص.
