...
- **الرقم التسلسليّ:** `ق-098` · **المعرّف الموحَّد:** `gr.lex.identifier` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-099` · **المعرّف الموحَّد:** `gr.lex.integer` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-100` · **المعرّف الموحَّد:** `gr.lex.double` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-101` · **المعرّف الموحَّد:** `gr.lex.string` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-102` · **المعرّف الموحَّد:** `gr.lex.raw_string` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-103` · **المعرّف الموحَّد:** `gr.lex.fstring` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-104` · **المعرّف الموحَّد:** `gr.lex.lifetime` · **الحالة:** stable · **منذ:** 1.0.0
...
- **الرقم التسلسليّ:** `ق-105` · **المعرّف الموحَّد:** `gr.lex.comment` · **الحالة:** stable · **منذ:** 1.0.0
- **الوصف:** تعليق سطر «#»، كتلة «#* *#»، توثيق «##» أو «#** **#»؛ تعليقات التوثيق تُرفَق بالتصريح الذي يليها مباشرة: أي سطر فاصل بعدها (فارغ أو تعليق عادي) يقطع الالتصاق فتُهمَل بتحذير «توثيق يتيم» (SYN024)، وكذلك إن انتهى الملف بعدها؛ وتعليق «##» في ذيل سطر كود يُعامَل تعليقًا عاديًا بتحذير «توثيق في ذيل سطر» (SYN025)
