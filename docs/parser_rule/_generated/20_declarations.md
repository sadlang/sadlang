...
- **الوصف:** «صدّر» تسبق تصريحاً (دالة/صنف/متغير) فتُتيحه للاستيراد من وحدات أخرى. تلتفّ حول تصريحٍ كامل لا حول قيمة؛ فـ«صدّر متغير ص = 42» و«صدّر دالة …» صحيحان. **قيد مترجم:** «صدّر بنية» لا يُترجَم (ISSUE-026)، و«صدّر *» مرفوض بالمحرّكين.
