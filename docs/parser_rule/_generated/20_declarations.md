...
- **الوصف:** «صدّر» تسبق تصريحاً (دالة/صنف/متغير/بنية) فتُتيحه للاستيراد من وحدات أخرى. تلتفّ حول تصريحٍ كامل لا حول قيمة؛ فـ«صدّر متغير ص = 42» و«صدّر دالة …» و«صدّر بنية …» صحيحة. «صدّر بنية» تُترجَم الآن عبر الوحدات (ISSUE-026 مُغلَق). **قيد مترجم:** «صدّر *» مرفوض بالمحرّكين.
