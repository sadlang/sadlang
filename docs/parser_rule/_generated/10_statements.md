...
flowchart LR
  ...
  n21["block"]
  n20 --> n21
  n1 -- "نطاق «من ... الى ...» ⇒ ForRangeStmt" --> n15
  n22(["⇒ ForStmt ∣ ForRangeStmt"])
  n21 --> n22
```
...
- **الوصف:** تعبير يُقيَّم كجملة لأثره الجانبيّ: استدعاء دالة، إسناد «س = قيمة»، إسناد مركّب «س += قيمة»، استدعاء طريقة «كائن.طريقة()»، تعبير حسابيّ… الإسناد نفسه تعبير فيصلح جملةً. المنقوطة «؛» في آخر الجملة **اختيارية** (السطر يفصل الجمل عادةً)، والمنقوطة اللاتينية `;` مقبولةٌ مكانها للتوافق (رمزان متميّزان، يقبلُهما المُحلِّلُ معًا) — والمعياريّةُ العربيّة.
