...
std::string CBasicTypeImpl::getArabicName() const {
    switch (basicType_) {
        ...
        case CBasicType::VOID:      return "\xd9\x81\xd8\xb1\xd8\xa7\xd8\xba";  // فراغ
        
        // --- (AR) أنواع صحيحة / (EN) Integer types ---
        case CBasicType::CHAR:      return "\xd8\xad\xd8\xb1\xd9\x81";          // حرف
        case CBasicType::SCHAR:     return "\xd8\xad\xd8\xb1\xd9\x81_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // حرف_موقّع
        case CBasicType::UCHAR:     return "\xd8\xad\xd8\xb1\xd9\x81_\xd8\xba\xd9\x8a\xd8\xb1_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // حرف_غير_موقّع
        case CBasicType::SHORT:     return "\xd9\x82\xd8\xb5\xd9\x8a\xd8\xb1";  // قصير
        case CBasicType::USHORT:    return "\xd9\x82\xd8\xb5\xd9\x8a\xd8\xb1_\xd8\xba\xd9\x8a\xd8\xb1_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // قصير_غير_موقّع
        case CBasicType::INT:       return "\xd8\xb5\xd8\xad\xd9\x8a\xd8\xad";  // صحيح
        case CBasicType::UINT:      return "\xd8\xb5\xd8\xad\xd9\x8a\xd8\xad_\xd8\xba\xd9\x8a\xd8\xb1_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // صحيح_غير_موقّع
        case CBasicType::LONG:      return "\xd8\xb7\xd9\x88\xd9\x8a\xd9\x84";  // طويل
        case CBasicType::ULONG:     return "\xd8\xb7\xd9\x88\xd9\x8a\xd9\x84_\xd8\xba\xd9\x8a\xd8\xb1_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // طويل_غير_موقّع
        case CBasicType::LONGLONG:  return "\xd8\xb7\xd9\x88\xd9\x8a\xd9\x84_\xd8\xac\xd8\xaf\xd8\xa7\xd9\x8b";  // طويل_جداً
        case CBasicType::ULONGLONG: return "\xd8\xb7\xd9\x88\xd9\x8a\xd9\x84_\xd8\xac\xd8\xaf\xd8\xa7\xd9\x8b_\xd8\xba\xd9\x8a\xd8\xb1_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // طويل_جداً_غير_موقّع
        
        // --- (AR) أنواع عشرية / (EN) Floating point types ---
        case CBasicType::FLOAT:     return "\xd8\xb9\xd8\xb4\xd8\xb1\xd9\x8a";  // عشري
        case CBasicType::DOUBLE:    return "\xd9\x85\xd8\xb2\xd8\xaf\xd9\x88\xd8\xac";  // مزدوج
        case CBasicType::LONGDOUBLE: return "\xd9\x85\xd8\xb2\xd8\xaf\xd9\x88\xd8\xac_\xd8\xb7\xd9\x88\xd9\x8a\xd9\x84";  // مزدوج_طويل
        
        // --- (AR) أنواع منطقية / (EN) Boolean types ---
        case CBasicType::BOOL:      return "\xd9\x85\xd9\x86\xd8\xb7\xd9\x82\xd9\x8a";  // منطقي
        
        // --- (AR) أنواع الحجم / (EN) Size types ---
        case CBasicType::SIZE_T:    return "\xd8\xad\xd8\xac\xd9\x85";  // حجم
        case CBasicType::SSIZE_T:   return "\xd8\xad\xd8\xac\xd9\x85_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // حجم_موقّع
        case CBasicType::PTRDIFF_T: return "\xd9\x81\xd8\xb1\xd9\x82_\xd9\x85\xd8\xa4\xd8\xb4\xd8\xb1";  // فرق_مؤشر
        case CBasicType::INTPTR_T:  return "\xd8\xb5\xd8\xad\xd9\x8a\xd8\xad_\xd9\x85\xd8\xa4\xd8\xb4\xd8\xb1";  // صحيح_مؤشر
        case CBasicType::UINTPTR_T: return "\xd8\xb5\xd8\xad\xd9\x8a\xd8\xad_\xd9\x85\xd8\xa4\xd8\xb4\xd8\xb1_\xd8\xba\xd9\x8a\xd8\xb1_\xd9\x85\xd9\x88\xd9\x82\xd9\x91\xd8\xb9";  // صحيح_مؤشر_غير_موقّع
        
        // --- (AR) أنواع ثابتة الحجم / (EN) Fixed-size types ---
        case CBasicType::INT8:      return "\xd8\xb5" "8";     // ص8
        case CBasicType::UINT8:     return "\xd8\xb5_\xd8\xba" "8";   // ص_غ8
        case CBasicType::INT16:     return "\xd8\xb5" "16";    // ص16
        case CBasicType::UINT16:    return "\xd8\xb5_\xd8\xba" "16";  // ص_غ16
        case CBasicType::INT32:     return "\xd8\xb5" "32";    // ص32
        case CBasicType::UINT32:    return "\xd8\xb5_\xd8\xba" "32";  // ص_غ32
        case CBasicType::INT64:     return "\xd8\xb5" "64";    // ص64
        case CBasicType::UINT64:    return "\xd8\xb5_\xd8\xba" "64";  // ص_غ64
        
        // --- (AR) أنواع خاصة / (EN) Special types ---
        case CBasicType::WCHAR_T:   return "\xd8\xad\xd8\xb1\xd9\x81_\xd8\xb9\xd8\xb1\xd9\x8a\xd8\xb6";  // حرف_عريض
        case CBasicType::CHAR16_T:  return "\xd8\xad\xd8\xb1\xd9\x81" "16";  // حرف16
        case CBasicType::CHAR32_T:  return "\xd8\xad\xd8\xb1\xd9\x81" "32";  // حرف32
...
std::string CBasicTypeImpl::getCName() const {
    switch (basicType_) {
        case CBasicType::VOID:      return "void";
        case CBasicType::CHAR:      return "char";
        case CBasicType::SCHAR:     return "signed char";
        case CBasicType::UCHAR:     return "unsigned char";
        case CBasicType::SHORT:     return "short";
        case CBasicType::USHORT:    return "unsigned short";
        case CBasicType::INT:       return "int";
        case CBasicType::UINT:      return "unsigned int";
        case CBasicType::LONG:      return "long";
        case CBasicType::ULONG:     return "unsigned long";
        case CBasicType::LONGLONG:  return "long long";
        case CBasicType::ULONGLONG: return "unsigned long long";
        case CBasicType::FLOAT:     return "float";
        case CBasicType::DOUBLE:    return "double";
        case CBasicType::LONGDOUBLE: return "long double";
        case CBasicType::BOOL:      return "_Bool";
        case CBasicType::SIZE_T:    return "size_t";
        case CBasicType::SSIZE_T:   return "ssize_t";
        case CBasicType::PTRDIFF_T: return "ptrdiff_t";
        case CBasicType::INTPTR_T:  return "intptr_t";
        case CBasicType::UINTPTR_T: return "uintptr_t";
        case CBasicType::INT8:      return "int8_t";
        case CBasicType::UINT8:     return "uint8_t";
        case CBasicType::INT16:     return "int16_t";
        case CBasicType::UINT16:    return "uint16_t";
        case CBasicType::INT32:     return "int32_t";
        case CBasicType::UINT32:    return "uint32_t";
        case CBasicType::INT64:     return "int64_t";
        case CBasicType::UINT64:    return "uint64_t";
        case CBasicType::WCHAR_T:   return "wchar_t";
        case CBasicType::CHAR16_T:  return "char16_t";
        case CBasicType::CHAR32_T:  return "char32_t";
...
size_t CBasicTypeImpl::getSize(bool is64Bit) const {
    switch (basicType_) {
        ...
        case CBasicType::CHAR16_T:  return 2;
        ...
        case CBasicType::WCHAR_T:   return 4;
        ...
        case CBasicType::UINTPTR_T: return is64Bit ? 8 : 4;
...
// ============================================================================
//                    (AR) تنفيذ CABICodeGenerator
//                    (EN) CABICodeGenerator Implementation
// ============================================================================
