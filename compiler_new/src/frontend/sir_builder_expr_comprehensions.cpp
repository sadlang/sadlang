...
namespace Sad
{
    namespace Compiler
    {
        namespace SIR
        {
            BuildResult SIRBuilder::buildExprListComp(AST::ListComprehensionExpr *listCompExpr)
            {
#ifndef NDEBUG
            ...
            // buildExprDictComp
            // ============================================================================
            BuildResult SIRBuilder::buildExprDictComp(AST::DictComprehensionExpr *dictCompExpr)
            {
#ifndef NDEBUG
