...
#include "sir_types.h"
// Source: shared/ast/include/*.h - مضاف في CMake include_directories
...
namespace Sad
{
    namespace LLVM
    {
         ...
         * llvm::Type* llvmType2 = mapper.mapSIRType(SIR::SadTypeKind::Integer);
         * @endcode
         */
        ...
        public:
             ...
             * @return نوع LLVM المقابل / Corresponding LLVM type
             */
            llvm::Type *mapSIRType(Compiler::SIR::SadTypeKind sirType);

            /**
             * @brief (AR) تحويل SadTypePtr (النظام الموحد) إلى نوع LLVM مباشرة
             * @brief (EN) Convert SadTypePtr (unified type system) to LLVM type directly
             * @param sadType مؤشر SadType الموحد / Unified SadType pointer
             * @return نوع LLVM المقابل / Corresponding LLVM type
             */
            llvm::Type *mapSadType(const Sad::Types::SadTypePtr &sadType);
             ...
             */
            llvm::PointerType *mapSIRTypeToPointer(Compiler::SIR::SadTypeKind sirType);
